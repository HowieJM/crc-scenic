...
> Note: we do **not** here redistribute the TAS Seurat object or derived loom (size and licensing). This repository begins at the TAS-only loom. The scripts to regenerate this loom from the TAS Seurat object are in `scripts/prefiltering/`.
